...
def create_app(
    *,
    ...
    async def on_domain_validation(request: Request, exc: Exception) -> JSONResponse:
        assert isinstance(exc, ValidationError)
        details = exc.errors(include_url=False, include_context=False)
        return _error_response(
            422, "validation_error", "invalid event", jsonable_encoder(details)
        )
    ...
    app.add_exception_handler(ValidationError, on_domain_validation)
